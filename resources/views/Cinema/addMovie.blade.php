...
<html lang="pt-br">
    ...
    <body>
        ...
        @csrf
            ...
            <div><label for="duracao">Duração</label><input type="text" name="duracao" id="duracao"></div>
            ...
            <div><label for="qnt_ingresso">Quantidade</label><input type="text" name="qnt_ingresso" id="qnt_ingresso"></div>
